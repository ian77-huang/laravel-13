...
<body
    ...
    <div
        ...
        <main class="flex w-full max-w-[335px] flex-col-reverse lg:max-w-4xl lg:flex-row">
            <div
                class="flex-1 rounded-bl-lg rounded-br-lg bg-white p-6 pb-6 text-[13px] leading-[20px] shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] lg:rounded-br-none lg:rounded-tl-lg lg:p-20 lg:pb-10 dark:bg-[#161615] dark:text-[#EDEDEC] dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d]">
                ...
                <p class="mt-6 text-[#706f6c] lg:mt-10 dark:text-[#A1A09A]">
                    v{{ app()->version() }}
            ...
            <div
                ...
                {{-- Laravel Logo --}}
                <svg class="duration-750 starting:opacity-0 motion-safe:starting:translate-y-6 w-full max-w-none translate-y-0 text-[#F53003] opacity-100 transition-all dark:text-[#F61500]"
                ...
                {{-- 13 --}}
                <svg class="relative -ml-8 -mt-[6.6rem] w-[438px] max-w-none [--stroke-color:#1B1B18] lg:ml-0 dark:[--stroke-color:#FF750F]"
